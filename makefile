...
supplementary = $(mainRfiles) $(otherRfiles) $(datasets) dissertation_nocode.pdf dissertation.pdf COPY.txt
...
supplementary.zip : $(supplementary)
	zip $@ $?

supplementary.tar : $(supplementary)
	tar -uf supplementary.tar $?
