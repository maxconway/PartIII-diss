...
<<methods_GDMO_timings2,fig.cap='predicted time taken using time for 1 FBA round'>>=
...
<<methods_GDMO_timings3,fig.cap='predicted time taken conditional on strain'>>=
