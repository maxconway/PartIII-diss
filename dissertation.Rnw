...
\documentclass[a4paper,twoside,12pt,notitlepage]{report}
...
\author{\emph{Author:}Maxwell Conway, University of Cambridge \\ \emph{Supervisor:} Dr. Pietro Lio', University of Cambridge \\ \emph{Data:} Dr. Muktak Aklujkar, Lovley Lab, University of Massachusetts}
\date{}
