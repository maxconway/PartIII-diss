...
The code chunks inserted are by no means necessary to understanding this document, they can be ignored or alternatively, a version with them removed is available online in the supplementary materials.
Obviously data files cannot be contained here, and some of the more mundane data handling scripts are also omitted. These can be found among supplementary materials.
