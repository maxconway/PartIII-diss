...
Genetic Design by Branch and Bound~\cite{Egen2012} is an enhancment on GDLS that can provide a large increase in speed by using a Branch and Bound strategy.
