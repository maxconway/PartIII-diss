...
<<comparison,echo=F,fig.cap='Geobacter Sulfurreducens Pareto front, overlaid with GDLS results',dependson='GDMO_fronts',fig.pos='htb'>>=
...
<<straight_line_verification1,fig.pos='p',out.width='\\textwidth', out.height='0.95\\textheight', fig.cap='Verification of Geobacter Metallireducens Pareto Front', fig.height=10, fig.width=5, fig.pos='p',dependson=c('GDMO_M','GDMO_S')>>=
