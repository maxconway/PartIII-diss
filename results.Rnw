...
colours=c(
  ...
  brewer.pal(n=nrow(GDMO.runs[GDMO.runs$strain=='metallireducens_glucose',]),name='Purples'),
  brewer.pal(n=nrow(GDMO.runs[GDMO.runs$strain=='metallireducens_plus',]),name='Purples'),
